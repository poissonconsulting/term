...
`term` is an R package to create, manipulate and query vectors of parameter terms.
A parameter term is the name of a parameter value, ie, "alpha", "beta[3]", "sigma2[1,4]".
