...
test_that("nterms.term", {
  ...
  expect_identical(nterms(c(NA_character_, "a")), NA_integer_)
  expect_identical(nterms(NA_character_, na.rm = TRUE), 0L)
  expect_identical(nterms(c(NA_character_, "a"), na.rm = TRUE), 1L)
