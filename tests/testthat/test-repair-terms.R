...
test_that("repair_terms", {
  ...
  expect_identical(repair_terms(as.term("")), term(0L))
  expect_identical(repair_terms(as.term("[1]")), term(0L))
  expect_identical(repair_terms(as.term("b[]")), term(0L))
  expect_identical(repair_terms(as.term("b[0]")),term(0L))
  expect_identical(repair_terms(as.term("b[1,]")), term(0L))
  ...
  expect_identical(repair_terms(as.term(c("b [  3 ]", "a [2]"))), 
                   as.term(c("b[3]", "a[2]")))
  expect_identical(repair_terms(as.term(c("a", ""))), as.term("a"))
  expect_identical(repair_terms(as.term(c("a[1]", ""))), as.term("a"))
